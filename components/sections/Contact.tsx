        ...
        >
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center pt-4 md:pt-8">
            ...
            <button
              type="button"
              onClick={() => reset()}
              className="w-full sm:w-auto px-8 md:px-16 py-4 border border-[#261A12] text-coffee rounded-full font-bold text-base md:text-lg hover:bg-[#1D1309] transition-all duration-500 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-cartier focus-visible:ring-offset-2"
            >
              {t.reset}
            </button>
          </div>
