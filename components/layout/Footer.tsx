    ...
    <footer className="w-full text-coffee py-12 px-6 md:px-12 lg:px-24 border-t border-gold/20">
      <div className="max-w-7xl mx-auto flex flex-col md:flex-row justify-between items-center gap-8">
        <div className="flex flex-col items-center md:items-start space-y-2">
          ...
          <p className="text-xs text-[#6C6D74] font-medium italic">
...
<div className="flex flex-col items-center md:items-end gap-4">
          <Link
            href="#main-content"
            className="text-xs uppercase tracking-[0.2em] font-bold text-[#6C6D74] hover:text-cartier transition-colors duration-300 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-cartier"
          >
            ↑ Back to top
          </Link>
