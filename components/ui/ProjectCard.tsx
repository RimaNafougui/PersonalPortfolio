            ...
            {isBackend ? (
              ...
              <div className="absolute inset-0 bg-[#111F35] flex flex-col items-center justify-center gap-2 opacity-100 md:opacity-0 md:group-hover:opacity-100 transition-opacity duration-300 md:delay-100">
                <div
                  ...
                  style={{
                    backgroundImage:
                      "repeating-linear-gradient(0deg,transparent,transparent 19px,rgba(237,232,223,0.04) 19px,rgba(237,232,223,0.04) 20px)," +
                      "repeating-linear-gradient(90deg,transparent,transparent 19px,rgba(237,232,223,0.04) 19px,rgba(237,232,223,0.04) 20px)",
                  }}
                />
